  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="card" style="width: 80%;">
        <img src="Imagenes/Calceta-Blanca.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Calceta Blanca</h5>
          <p class="card-text">Calceta Blanca Basica</p>
    ...
    <div class="col-md-4">
      <div class="card" style="width: 80%;">
        <img src="Imagenes/Calceta-Gris.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Calceta Gris</h5>
          <p class="card-text">Calceta Gris Basica</p>
          <a href="#" id="botonplayera" class="btn btn-primary">Añadir</a>
          <a href="#" id="botonplayeratalla" class="btn btn-primary">Talla</a>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="card" style="width: 80%;">
        <img src="Imagenes/Calceta-Negra.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Calceta Negra</h5>
          <p class="card-text">Calceta Negra Basica</p>
          <a href="#" id="botonplayera" class="btn btn-primary">Añadir</a>
          <a href="#" id="botonplayeratalla" class="btn btn-primary">Talla</a>
        </div>
      </div>
